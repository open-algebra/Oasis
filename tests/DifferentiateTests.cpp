...
TEST_CASE("Differentiate Quotient Rule Like Terms", "[Differentiate][Divide][Like]")
{
    ...
    Oasis::Divide<Oasis::Add<Oasis::Variable, Oasis::Real>, Oasis::Add<Oasis::Variable, Oasis::Real>> diff1 { Oasis::Add<Oasis::Variable, Oasis::Real> { Oasis::Variable { var.GetName() },
                                                                                                                  Oasis::Real { 2 } },
        Oasis::Add<Oasis::Variable, Oasis::Real> { Oasis::Variable { var.GetName() }, Oasis::Real { 3 } } };
    Oasis::Divide<Oasis::Expression, Oasis::Multiply<Oasis::Expression, Oasis::Expression>> answer { Oasis::Subtract<Oasis::Multiply<Oasis::Add<Oasis::Variable, Oasis::Real>, Oasis::Real>> { Oasis::Multiply<Oasis::Add<Oasis::Variable, Oasis::Real>, Oasis::Real> { Oasis::Add<Oasis::Variable, Oasis::Real> { Oasis::Variable { var.GetName() }, Oasis::Real { 3 } },
                                                                                                                                                                                                   Oasis::Real { 1 } },
                                                                                                         Oasis::Multiply<Oasis::Add<Oasis::Variable, Oasis::Real>, Oasis::Real> {
                                                                                                             ...
                                                                                                             Oasis::Real { 1 } } },
        Oasis::Multiply<Oasis::Expression, Oasis::Expression> { Oasis::Add<Oasis::Variable, Oasis::Real> { Oasis::Variable { var.GetName() }, Oasis::Real { 3 } }, Oasis::Add<Oasis::Variable, Oasis::Real> { Oasis::Variable { var.GetName() }, Oasis::Real { 3 } } } };
    auto diffed = diff1.Differentiate(var);
    auto simplified = diffed->Accept(simplifyVisitor).value();
...
TEST_CASE("Differentiate Multiple Variables Differentiate", "[Differentiate][Multiply][Different]")
{
    Oasis::Variable x { "x" };
    Oasis::Variable y { "y" };
    Oasis::Multiply<Oasis::Variable, Oasis::Variable> xy { Oasis::Variable { x.GetName() }, Oasis::Variable { y.GetName() } };
...
TEST_CASE("Differentiate Multiple Variables + Real Differentiate", "[Differentiate][Multiply][Different]")
{
    ...
    Oasis::Multiply<Oasis::Real, Oasis::Expression> threexy { Oasis::Real { 3 }, *(xy.Copy()) };
    Oasis::Multiply<Oasis::Real, Oasis::Variable> threex { Oasis::Real { 3 }, Oasis::Variable { x.GetName() } };
...
{
    Oasis::Variable x { "x" };
    Oasis::Derivative<Oasis::Add<Oasis::Variable, Oasis::Real>, Oasis::Variable> diff1 { Oasis::Add<Oasis::Variable, Oasis::Real> { Oasis::Variable { x.GetName() },
                                                                                             Oasis::Real { 2 } },
        Oasis::Variable { x.GetName() } };
    Oasis::Real one { 1 };
...
{
    Oasis::Variable x { "x" };
    Oasis::Derivative<Oasis::Subtract<Oasis::Variable, Oasis::Real>, Oasis::Variable> diff1 { Oasis::Subtract<Oasis::Variable, Oasis::Real> { Oasis::Variable { x.GetName() },
                                                                                                  Oasis::Real { 2 } },
        Oasis::Variable { x.GetName() } };
    Oasis::Real one { 1 };
    auto diffed = diff1.Accept(simplifyVisitor).value();
...
{
    Oasis::Variable x { "x" };
    Oasis::Derivative<Oasis::Multiply<Oasis::Variable, Oasis::Real>, Oasis::Variable> diff1 { Oasis::Multiply<Oasis::Variable, Oasis::Real> { Oasis::Variable { x.GetName() },
                                                                                                  Oasis::Real { 2 } },
        Oasis::Variable { x.GetName() } };
    Oasis::Real two { 2 };
    auto diffed = diff1.Accept(simplifyVisitor).value();
...
{
    Oasis::Variable x { "x" };
    Oasis::Derivative<Oasis::Divide<Oasis::Variable, Oasis::Real>, Oasis::Variable> diff1 { Oasis::Divide<Oasis::Variable, Oasis::Real> { Oasis::Variable { x.GetName() },
                                                                                                Oasis::Real { 2 } },
        Oasis::Variable { x.GetName() } };
    Oasis::Real half { 0.5f };
    auto diffed = diff1.Accept(simplifyVisitor).value();
...
{
    Oasis::Variable x { "x" };
    Oasis::Derivative<Oasis::Real, Oasis::Variable> diff1 { Oasis::Real { 2 }, Oasis::Variable { x.GetName() } };
    Oasis::Real zero { 0 };
    auto diffed = diff1.Accept(simplifyVisitor).value();
...
{
    Oasis::Variable x { "x" };
    Oasis::Derivative<Oasis::Variable, Oasis::Variable> diff1 { Oasis::Variable { x.GetName() }, Oasis::Variable { x.GetName() } };
    Oasis::Real one { 1 };
    auto diffed = diff1.Accept(simplifyVisitor).value();
    REQUIRE(diffed->Equals(*(one.Accept(simplifyVisitor).value())));
}
...
{
    Oasis::Variable x { "x" };
    Oasis::Derivative<Oasis::Exponent<Oasis::Variable, Oasis::Real>, Oasis::Variable> diff1 { Oasis::Exponent<Oasis::Variable, Oasis::Real> { Oasis::Variable { x.GetName() },
                                                                                                  Oasis::Real { 2 } },
        Oasis::Variable { x.GetName() } };
...
TEST_CASE("Real Base Logarithm Derivative", "[Derivative][Logarithm][Euler's Real]")
{
    ...
    Oasis::Divide expected { Oasis::Real { 1.0 }, Oasis::Multiply { Oasis::Variable { "x" }, Oasis::Log { Oasis::EulerNumber {}, Oasis::Real { 10.0 } } } };
...
TEST_CASE("Variable Base Logarithm Derivative", "[Derivative][Logarithm][Variable]")
{
    ...
    auto diff = diffLog.Accept(simplifyVisitor).value();
    Oasis::Divide expected { Oasis::Real { 1.0 }, Oasis::Multiply { Oasis::Variable { "x" }, Oasis::Log { Oasis::EulerNumber {}, Oasis::Variable { "y" } } } };
    REQUIRE(diff->Equals(expected));
}
...
TEST_CASE("Variable Base Exponential Derivative", "[Derivative][Exponent]")
{
    ...
    Oasis::Multiply expected {
        exp,
        Oasis::Add { Oasis::Multiply { Oasis::Log { Oasis::EulerNumber {}, Oasis::Variable { "x" } },
                         Oasis::Real { 2.0 } },
            Oasis::Real { 2.0 } },
    };
    auto simplified = diffExp.Accept(simplifyVisitor).value();
