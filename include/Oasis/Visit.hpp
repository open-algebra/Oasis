...
public:
    ...
    virtual any Visit(const Arcsine<Expression>& arcsine) = 0;
    virtual any Visit(const Arccosine<Expression>& arccosine) = 0;
    virtual any Visit(const Arctan<Expression>& arctan) = 0;
...
public:
    ...
    auto Visit(const Arcsine<Expression>& arcsine) -> any final { return TypedVisit(arcsine); }
    auto Visit(const Arccosine<Expression>& arccosine) -> any final { return TypedVisit(arccosine); }
    auto Visit(const Arctan<Expression>& arctan) -> any final { return TypedVisit(arctan); }
...
protected:
    ...
    virtual auto TypedVisit(const Arcsine<Expression>& arcsine) -> RetT = 0;
    virtual auto TypedVisit(const Arccosine<Expression>& arccosine) -> RetT = 0;
    virtual auto TypedVisit(const Arctan<Expression>& arctan) -> RetT = 0;
